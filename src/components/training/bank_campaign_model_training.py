...
bucket = storage_client.bucket("udemy_gcp-mlops")
...
def save_model_artifact(model_name, pipeline):
    ...
    model_artifact = bucket.blob('ml-artifacts/bank_campaign/'+artifact_name)
    model_artifact.upload_from_filename(artifact_name)

def load_model_artifact(file_name):
    blob = bucket.blob("ml-artifacts/bank_campaign/" + file_name)
...
def main():
    input_data_path = "gs://udemy_gcp-mlops/data/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
